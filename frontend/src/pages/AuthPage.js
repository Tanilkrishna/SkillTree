  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        {/* Hero Section */}
        <div className="text-white space-y-6" data-testid="hero-section">
          <div className="flex items-center gap-3">
            <TreePine className="w-12 h-12" />
            <h1 className="text-5xl font-bold">SkillTree</h1>
          </div>
          <p className="text-xl text-white/90">
            Master your learning journey with AI-powered skill tracking and gamified progress visualization.
          </p>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span>Gamified skill tree visualization</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
              ...
              <span>Connect GitHub, LinkedIn, YouTube</span>
            </div>
          </div>
        </div>

        {/* Auth Card */}
        <Card className="p-8 shadow-2xl" data-testid="auth-card">
          <div className="text-center space-y-6">
            <div>
              <h2 className="text-2xl font-bold mb-2">Welcome to SkillTree</h2>
