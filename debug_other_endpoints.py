...
def test_other_endpoints():
    ...
    try:
        response = requests.get(
            "https://dev-journey-103.preview.emergentagent.com/api/achievements",
            headers=headers,
            timeout=30
        )
    ...
    try:
        response = requests.get(
            "https://dev-journey-103.preview.emergentagent.com/api/activity-feed",
            headers=headers,
            timeout=30
        )
    ...
    try:
        response = requests.get(
            "https://dev-journey-103.preview.emergentagent.com/api/dashboard/stats",
            headers=headers,
            timeout=30
        )
